...
final class GlyphStrokeTrackerTest {
    ...
    @Test void importedDraftPreservesSegmentWidths() {
        var draft = new dev.mintychochip.wizardry.api.glyph.GlyphDraft(java.util.List.of(
                new dev.mintychochip.wizardry.api.glyph.GlyphStroke(
                        java.util.List.of(
                                new dev.mintychochip.wizardry.api.glyph.GlyphPoint(1, 1),
                                new dev.mintychochip.wizardry.api.glyph.GlyphPoint(2, 2),
                                new dev.mintychochip.wizardry.api.glyph.GlyphPoint(3, 3)),
                        4,
                        10,
