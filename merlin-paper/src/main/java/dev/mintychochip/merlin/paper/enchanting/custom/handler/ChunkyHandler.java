...
public final class ChunkyHandler implements OvercapEffectHandler, ArmorDefenseTrigger {
    private static final NamespacedKey KEY = CustomEnchantmentSupport.customKey("chunky");
    ...
    public void onArmorDefense(Player defender, Entity attacker, MutableDamage damage, int level) {
        ...
        damage.multiply(ArmorDefenseSupport.reductionMultiplier(level, 0.05));
    }
}
