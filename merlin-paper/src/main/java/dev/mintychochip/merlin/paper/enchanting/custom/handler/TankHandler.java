...
public final class TankHandler implements OvercapEffectHandler, ArmorDefenseTrigger {
    private static final NamespacedKey KEY = CustomEnchantmentSupport.customKey("tank");
    ...
    public void onArmorDefense(Player defender, Entity attacker, MutableDamage damage, int level) {
        if (damage == null || damage.isCancelled() || level <= 0 || damage.getInitialDamage() <= 0.0
                ...
                || !ArmorDefenseSupport.attackerHolds(living, "_AXE")) return;
