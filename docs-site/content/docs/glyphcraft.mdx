...
Relevant sources: [GlyphCommand.java](https://github.com/aincraft-org/merlin/blob/master/merlin-paper/src/main/java/dev/mintychochip/merlin/paper/mapgui/GlyphCommand.java), [GlyphDraftStoreAdapter.java](https://github.com/aincraft-org/merlin/blob/master/merlin-paper/src/main/java/dev/mintychochip/merlin/paper/mapgui/GlyphDraftStoreAdapter.java), [GlyphTomeStore.java](https://github.com/aincraft-org/merlin/blob/master/merlin-paper/src/main/java/dev/mintychochip/merlin/paper/tome/GlyphTomeStore.java), and [Glyphcraft language guide](/docs/glyphcraft).

---

## Full Glyphcraft tome language guide
