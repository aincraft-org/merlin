...
Relevant sources: [ScribeCommand.java](https://github.com/aincraft-org/merlin/blob/master/merlin-paper/src/main/java/dev/mintychochip/merlin/paper/command/ScribeCommand.java), [ScribeBookStore.java](https://github.com/aincraft-org/merlin/blob/master/merlin-paper/src/main/java/dev/mintychochip/merlin/paper/book/ScribeBookStore.java), [SpellRuntime.java](https://github.com/aincraft-org/merlin/blob/master/merlin-paper/src/main/java/dev/mintychochip/merlin/paper/runtime/SpellRuntime.java), and [Scribe language guide](/docs/scribe).

---

## Full Scribe phrasebook
