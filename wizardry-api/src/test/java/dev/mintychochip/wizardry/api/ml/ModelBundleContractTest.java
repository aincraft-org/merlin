...
final class ModelBundleContractTest {
    ...
    @Test void rejectsOneChannelRasterSchema() throws Exception {
        Path dir = fixture();
        String manifest = Files.readString(dir.resolve("manifest.json")).replace("[null,3,64,64]", "[null,1,64,64]");
        Files.writeString(dir.resolve("manifest.json"), manifest);
        assertRejected(dir, true);
    }
    ...
    static Path fixture() throws Exception {
        ...
        String labels = "[\"target-ray\",\"damage\",\"heal\",\"push\",\"cooldown\",\"self\",\"target\",\"physical\",\"fire\",\"frost\",\"arcane\",\"on-hit\",\"on-hurt\",\"on-use\",\"periodic\",\"if-health\",\"if-undead\",\"if-outdoors\",\"shield\",\"attacker\",\"area\",\"repeat\",\"charges\",\"reject\"]";
        String manifest = "{\"schema_id\":\"glyph-bundle-v1\",\"model_id\":\"model-v1\",\"catalog_id\":\"glyph-catalog-v1\",\"preprocessing_id\":\"preprocessing-v1\",\"dataset_id\":\"dataset-v1\",\"training_id\":\"train-v1\",\"release_ready\":false,\"files\":{\"model.onnx\":\""+hash+"\"},\"labels\":"+labels+",\"input_schema\":{\"vectors\":{\"shape\":[null,64,32,8],\"dtype\":\"float32\"},\"mask\":{\"shape\":[null,64,32],\"dtype\":\"float32\"},\"raster\":{\"shape\":[null,3,64,64],\"dtype\":\"float32\"}},\"output_schema\":{\"logits\":{\"shape\":[null,24],\"dtype\":\"float32\"}},\"calibration\":{\"temperature\":1.0,\"top_threshold\":0.75,\"margin\":0.1},\"metrics\":{\"accuracy\":0.9},\"golden_fixture\":{\"input\":\"x\"},\"opset\":17}";
